              ...
              <header className={`min-h-screen lg:h-1/2 bg-azul-oscuro relative`}>
                    ...
                    <div className='flex flex-col items-center justify-center absolute -top-28 z-50 w-full min-h-screen my-10' >
                      ...
                      <div className='flex flex-col md:flex-row justify-center items-center gap-4 mt-9'>
                        <Link href='https://github.com/ifernandezNv' target='_blank' noreferer alt='Github profile' className='text-white text-movil-xl md:text-sm font-bold flex gap-3 items-center '>
                          <iconify-icon icon="tabler:brand-github" style={{color: 'white'}} width={26} height={26}></iconify-icon>
                          Github
                        </Link>
                      
                        <Link href='https://www.linkedin.com/in/isaac-fern%C3%A1ndez-navarro-b41870215/' target='_blank' noreferer alt='Github profile' className='text-white text-movil-xl md:text-sm font-bold flex gap-3 items-center justify-center'>
